...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/llVAMPIREKINGll/Kritinewbot",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

API_URL = getenv("API_URL", 'https://pytdbotapi.thequickearn.xyz') #youtube song url
VIDEO_API_URL = getenv("VIDEO_API_URL", 'https://api.video.thequickearn.xyz')
API_KEY = getenv("API_KEY", 'NxGBNexGenBotsd4f774') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz


PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-YukkiMusic-08-30")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/llTEAM_VAMPIREll")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/llTEAM_VAMPIRElll")
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/v7cak2.jpg")
PLAYLIST_IMG_URL = "https://files.catbox.moe/f2s4ws.jpg"
STATS_IMG_URL = "https://files.catbox.moe/v7cak2.jpg"
